...
ggplot(uswages, aes(x=exper, y=wage)) +
  ...
  geom_abline(intercept=mod2$coefficients[1]+mod2$coefficients[3], slope=mod2$coefficients[2], color="blue") + ggtitle("us wages vs years of experience with smsa unit wage difference")
```
